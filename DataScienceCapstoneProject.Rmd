...
The code for data processing can be found in the Code section at the bottom of this document.
...
```{r wordcloud}
textplot_wordcloud(capstone_dfm, color = rev(RColorBrewer::brewer.pal(10, "RdBu")))
```
